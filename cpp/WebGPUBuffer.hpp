...
public:
  ...
  std::shared_ptr<Promise<void>> mapAsync(double mode, std::optional<double> offset, std::optional<double> size) override;
  std::shared_ptr<ArrayBuffer> getMappedRange(std::optional<double> offset, std::optional<double> size) override;
  void unmap() override;
